...
export class InstagramMessageService {
   ...
   */
  public static async sendText(recipientId: string, text: string): Promise<boolean> {
   ...
   */
  public static async sendMainMenu(recipientId: string, customText?: string): Promise<boolean> {
